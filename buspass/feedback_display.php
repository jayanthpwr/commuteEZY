                 ...
                 <div class="card">
                            <div class="card-body">
                                <div class="table-responsive m-t-40">
                                  ...
                                  $sql1 = "SELECT * FROM  `tbl_feedback` order by id desc";
                           ...
                           $sql2="select * from tbl_student where id='".$row['student_id']."'";
                                   $result2 = $conn->query($sql2);
                                    ...
                                    $row1 = $result2->fetch_assoc();
                                                  ...
                                                  echo $row1['sfname'];?>&nbsp;<?php echo$row1['slname']; ?></td>
                                            ...
                                            <td><?php
                                                ...
                                                <td><?php
$c1 = "SELECT * FROM `tbl_feedback` where student_id='".$row1['id']."'  and reply_check='1'";
...
echo "Reply Added!";
                                                 ...
                                                 <?php }
                                                   ...
                                                   <a href="edit_feedback.php?id=<?=$row1['id'];?>"><button type="button" class="btn btn-xs btn-primary" ><i class="fa fa-reply" data-toggle="tooltip" title="Edit"></i></button></a>
                                               <?php } ?>
                                                 </td>
