  ...
  if($_FILES["image"]["tmp_name"]!=''){
   ...
   if (move_uploaded_file($_FILES["image"]["tmp_name"], $image)) {
     ...
     $image1 =$_POST['old_image'];
  	...
  	$sql = "INSERT INTO `tbl_conductor`(`fname`, `lname`, `email`, `password`, `gender`, `dob`, `contact`, `address`, `image`) VALUES ('$fname', '$lname',  '$email','$pass', '$gender', '$dob', '$contact', '$address','$image1')";
