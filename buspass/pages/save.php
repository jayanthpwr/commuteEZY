 ...
 $target_dir = "../uploadImage/student/";
  ...
  if($_FILES["image2"]["tmp_name"]!=''){
   ...
   if (move_uploaded_file($_FILES["image2"]["tmp_name"], $image)) {
	...
	$sql = "INSERT INTO `tbl_student`(`stud_id`,`sfname`, `slname`, `semail`,`password`, `sgender`, `sdob`, `scontact`, `saddress`,`regno`,`session`,`image1`,`image2`) VALUES ('$stud_id','$sfname', '$slname', '$semail','$pass', '$sgender', '$sdob', '$scontact', '$saddress', '$regno', '$sessionn','$image1','$image2')";
