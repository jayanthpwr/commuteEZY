...
if(isset($_POST['update']))
             {
                extract($_POST);
                      echo$q1="UPDATE `tbl_feedback` SET  `reply`='$reply',`reply_check`=1 WHERE `student_id`='".$_GET['id']."'";
                   if ($conn->query($q1) === TRUE) {
      $_SESSION['success']=' Reply Added Successfully';
     ?>
<!--                <script>alert(' Reply Added Successfully');</script>
 -->
...
?>
<?php
$que="SELECT * FROM `tbl_feedback` WHERE student_id='".$_GET['id']."'";
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Add Reply</h3> </div>
...
<div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea type="text" name="reply" class="form-control"  id="" placeholder="Reply" required="" style="height: 200px;"><?php echo $reply;?></textarea>
                                                     </div>
                                            </div>
                                        </div>
                                        ...
                                        <button type="submit" name="update" class="btn btn-sucess btn-flat m-b-30 m-t-30" id="0">Submit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
