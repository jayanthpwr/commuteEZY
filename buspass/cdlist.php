        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary"> Check dues list</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">View  Check Dues list</li>
                    </ol>
                </div>
            </div>
                 ...
                 <div class="card">
                            <div class="card-body">
                                <div class="table-responsive m-t-40">
                                  ...
                                  $sql1 = "SELECT * FROM  `applypass` where request='1'  and enddate<'".$current_date."'";
