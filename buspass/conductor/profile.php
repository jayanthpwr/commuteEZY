  ...
  if($_FILES["image"]["tmp_name"]!=''){
   ...
   if (move_uploaded_file($_FILES["image"]["tmp_name"], $image)) {
     ...
     $image1 =$_POST['old_image'];
      ...
      $q1="UPDATE `tbl_conductor` SET  `fname`='$fname',`lname`='$lname',`email`='$email',`gender`='$gender',`dob`='$dob',`contact`='$contact',`address`='$address',`image`='$image1' WHERE `id`='".$_SESSION["id"]."'";
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Conductor </h3> </div>
