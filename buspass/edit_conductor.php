  ...
  if($_FILES["image"]["tmp_name"]!=''){
   ...
   if (move_uploaded_file($_FILES["image"]["tmp_name"], $image)) {
     ...
     $image1 =$_POST['old_image'];
      ...
      $q1="UPDATE `tbl_conductor` SET  `fname`='$fname',`lname`='$lname',`email`='$email',`gender`='$gender',`dob`='$dob',`contact`='$contact',`address`='$address',`image`='$image1' WHERE `id`='".$_GET['id']."'";
...
?>
<?php
$que="SELECT * FROM `tbl_conductor` WHERE id='".$_GET["id"]."'";
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Conductor Management</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Edit Conductor Management</li>
                    </ol>
                </div>
            </div>
