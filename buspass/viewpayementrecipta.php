...
<?php
 ...
 $sql2 = "SELECT * FROM `applypass` WHERE studentid='".$_GET['id']."'";
...
<div class="page-wrapper">
  <div class="row page-titles">
      <div class="col-md-5 align-self-center">
          <h3 class="text-primary">View Payment Receipt</h3> </div>
            ...
            <div id='printarea'>
              <table style="width: 100%;">
                <tr>
                  ...
                  <td>
                    <center>
                      <h2>MAHARASHTRA STATE ROAD TRASPORT CORPORATION</h2>
                      <h3 class="btn btn-success">Payment Receipt</h3>
                    </center>
                  </td>
                </tr>
              </table>
              ...
              <table style="width: 100%;">
                <tr>
                  <td>
                    ...
                    <img class="profile-img" src="uploadImage/Profile/<?=$mydetail['image']?>" style="width:40%;"  style="height:70px;" >
